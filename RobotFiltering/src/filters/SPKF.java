...
public class SPKF implements Filter {
	...
	protected FuzzySPKF cFController;
	...
	public SPKF(Control Controller, Data Dataset, Double initQ, Double initR) {
		...
		if (cController.getControlType() == 2)
			cFController = (FuzzySPKF) Controller;
		dDataset = Dataset;
		this.setAlpha(0.02);
		this.setBeta(2.0);
		this.setKappa(0.0);
	...
	public SPKF(Control Controller, Data Dataset, Double initQ, Double initR, Double Alpha, Double Beta, Double Kappa) {
		cController = (SPKFControl) Controller;
		dDataset = Dataset;
		this.setAlpha(Alpha);
		this.setBeta(Beta);
	...
	public void outputData(String FileName) {
		try {
			...
			// BufferedWriter outH1 = new BufferedWriter(new FileWriter(FileName
			// + "HeadingOne"));
			// BufferedWriter outH = new BufferedWriter(new FileWriter(FileName
			// + "Heading"));
			// BufferedWriter outD = new BufferedWriter(new FileWriter(FileName
			// + "Drive"));
			int len = Output.size();
			...
			// outH1.write(C.GetTimestep() + "," + C.GetRad() + "," + B.get(0,
			// 0) + "," + B.get(1, 0) + "," + B.get(2, 0));
			// outH1.newLine();
			// }
			// outH1.close();
			...
			// outH.write(C.GetTimestep() + "," + C.GetRad() + "," + B.get(0, 0)
			// + "," + B.get(1, 0) + "," + B.get(2, 0));
			// outH.newLine();
			// }
			// outH.close();
			// OdoEntry D;
			// outD.write("Timestep, DriveX, DriveY, DriveDelta, ResidX, ResidY,
			// ResidZ");
			// outD.newLine();
			// for (int i = 0; i < len; i++) {
			// D = OutputD.elementAt(i);
			// B = ResidD.elementAt(i);
			// outD.write(D.getOdoTimestamp() + "," + D.getOdoX() + "," +
			// D.getOdoY() + "," + D.getOdoTheta() + "," + B.get(0, 0) + "," +
			// B.get(1, 0) + "," + B.get(2, 0));
			// outD.newLine();
			// }
			// outD.close();
